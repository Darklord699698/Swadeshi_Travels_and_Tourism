  ...
  <div>
    ...
    <p className="text-xl font-bold text-slate-800">{formData.nights || 1} Day{(formData.nights || 1) > 1 ? 's' : ''}</p>
          ...
          <div className="flex gap-8">
            ...
            <button className="button" onClick={handleExecutePayment} style={{flex: 2}}>
...
<div className="space-y-3">
  ...
  <input
    ...
    inputMode="numeric"
    maxLength={6}
    className="w-full p-6 text-3xl font-bold transition-all border-none outline-none bg-slate-50 rounded-3xl focus:ring-4 focus:ring-orange-100 text-slate-700"
    placeholder="Ex. 560064, 560035"
