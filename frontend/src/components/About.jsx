...
const About = () => {
  ...
  const destinationMap = {
    ...
    Leh: { district: "Leh", nearby: ["Kargil", "Nubra"] },
Amritsar: { district: "Amritsar", nearby: ["Gurdaspur", "Tarn Taran"] },
Patna: { district: "Patna", nearby: ["Nalanda", "Vaishali"] },
Tawang: { district: "Tawang", nearby: ["West Kameng", "East Kameng"] },
Kohima: { district: "Kohima", nearby: ["Dimapur", "Mokokchung"] },
Imphal: { district: "Imphal West", nearby: ["Imphal East", "Bishnupur"] },
Aizawl: { district: "Aizawl", nearby: ["Champhai", "Lunglei"] },
Agartala: { district: "West Tripura", nearby: ["Sepahijala", "Khowai"] },
Bhubaneswar: { district: "Khordha", nearby: ["Cuttack", "Nayagarh"] },
Raipur: { district: "Raipur", nearby: ["Durg", "Balodabazar"] },
Ranchi: { district: "Ranchi", nearby: ["Ramgarh", "Khunti"] },
Bhopal: { district: "Bhopal", nearby: ["Sehore", "Raisen"] },
Bengaluru: { district: "Bengaluru Urban", nearby: ["Bengaluru Rural", "Ramanagara"] },
Chennai: { district: "Chennai", nearby: ["Kanchipuram", "Chengalpattu"] },
Amaravati: { district: "Guntur", nearby: ["Krishna", "Prakasam"] },
"Port Blair": { district: "South Andaman", nearby: ["North and Middle Andaman", "Nicobar"] },
Puducherry: { district: "Puducherry", nearby: ["Villupuram", "Cuddalore"] },
Dehradun: { district: "Dehradun", nearby: ["Haridwar", "Tehri Garhwal"] },
Rudraprayag: { district: "Rudraprayag", nearby: ["Chamoli", "Tehri Garhwal"] },
Badrinath: { district: "Chamoli", nearby: ["Rudraprayag", "Uttarkashi"] },
Gangotri: { district: "Uttarkashi", nearby: ["Chamoli", "Tehri Garhwal"] },
Yamunotri: { district: "Uttarkashi", nearby: ["Dehradun", "Tehri Garhwal"] },
Kedarnath: { district: "Rudraprayag", nearby: ["Chamoli", "Tehri Garhwal"] },
Nainital: { district: "Nainital", nearby: ["Almora", "Udham Singh Nagar"] },
"Rishikesh & Haridwar": { district: "Dehradun", nearby: ["Haridwar", "Tehri Garhwal"] },
Almora: { district: "Almora", nearby: ["Nainital", "Bageshwar"] },
Chopta: { district: "Rudraprayag", nearby: ["Chamoli", "Tehri Garhwal"] },
Chakrata: { district: "Dehradun", nearby: ["Uttarkashi", "Tehri Garhwal"] },
"Hemkund Sahib": { district: "Chamoli", nearby: ["Rudraprayag", "Uttarkashi"] },
// International
Paris: { district: "Île-de-France", nearby: ["Seine-et-Marne", "Yvelines"] },
Bangkok: { district: "Bangkok", nearby: ["Nonthaburi", "Samut Prakan"] },
Tokyo: { district: "Shinjuku", nearby: ["Shibuya", "Minato"] },
Dubai: { district: "Dubai", nearby: ["Sharjah", "Abu Dhabi"] },
Singapore: { district: "Central Region", nearby: ["East Region", "West Region"] },
Bali: { district: "Badung", nearby: ["Gianyar", "Tabanan"] },
London: { district: "Greater London", nearby: ["Surrey", "Essex"] },
"New York City": { district: "Manhattan", nearby: ["Brooklyn", "Queens"] },
Sydney: { district: "Sydney CBD", nearby: ["Parramatta", "North Sydney"] },
Rome: { district: "Rome", nearby: ["Lazio", "Tivoli"] },
Amsterdam: { district: "Amsterdam", nearby: ["Haarlem", "Utrecht"] },
Barcelona: { district: "Barcelona", nearby: ["Hospitalet", "Badalona"] },
Phuket: { district: "Phuket", nearby: ["Phang Nga", "Krabi"] },
"Cape Town": { district: "City of Cape Town", nearby: ["Stellenbosch", "Franschhoek"] },
Moscow: { district: "Central Moscow", nearby: ["Moscow Oblast", "Khimki"] },
Istanbul: { district: "Fatih", nearby: ["Beyoglu", "Kadikoy"] },
Athens: { district: "Athens", nearby: ["Piraeus", "Glyfada"] },
Male: { district: "Malé", nearby: ["Hulhumalé", "Maafushi"] },
Cairo: { district: "Cairo", nearby: ["Giza", "Heliopolis"] },
Seoul: { district: "Jung-gu", nearby: ["Gangnam", "Mapo"] },
  };
